...
<ul class="pagination">
  ...
  <li class="active"><a href="/HW/workrequest.do">Manage My Work Requests</a></li>
  <li><a href="/HW/profile.do">Manage My Profile</a></li>
  <li><a href="/HW/interest.do">People interested in my requests</a></li>
</ul>

</center>
<form action="/HW/processmanage.do" method="get">
...
<div class="col-xs-4">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="id" name="id" placeholder="Enter Your Job-ID">
    </div>
</div>
<div class="col-xs-4">
</div>
